...
public class FacturaAdapter extends ArrayAdapter<String> {
    Context context;
    Vector images;
    //String[] programName;
    Vector id;
    ...
    public FacturaAdapter(Context context, Vector id, Vector images, Vector cedula,  Vector fechas  ) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(singleItem == null){
            ...
            singleItem = layoutInflater.inflate(R.layout.vistafactuara_items, parent, false);
            ...
            holder = new FacturaViewHolder(singleItem);
        ...
        // If singleItem is not null then we'll be recycling
            ...
            holder = (FacturaViewHolder) singleItem.getTag();
        }
...
//        holder.subtotal.setText(Subtotal.get(position).toString());
        holder.txtidFactura.setText(id.get(position).toString());
        holder.txtcedula.setText(cedula.get(position).toString());
        holder.txtFecha.setText(fecha.get(position).toString());
...
//                });
              //  Toast.makeText(context, id.get(position).toString(), Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(getContext(), VistaComprasId.class);
                intent.putExtra("idFactura", id.get(position).toString());
                context.startActivity(intent);
